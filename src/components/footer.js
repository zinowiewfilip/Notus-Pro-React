  ...
  return (
    <div className="footer-container">
      <div className="footer-container01">
        <div className="footer-container02">
          ...
          <div className="footer-container03">
            <a
              href="https://www.facebook.com/profile.php?id=61563374483035"
              target="_blank"
            ...
            <a
              href="https://www.linkedin.com/company/fzsolutions-pl/"
              target="_blank"
              rel="noreferrer noopener"
            ...
            <a
              href="https://www.instagram.com/fzsolutions.pl/"
              target="_blank"
              rel="noreferrer noopener"
            ...
            <a
              href="https://x.com/fzsolutionspl"
              target="_blank"
              rel="noreferrer noopener"
        ...
        <div className="footer-container08">
          <div className="footer-container09">
            <span className="footer-text3 TextXS">Contact</span>
            <span className="footer-text4 TextSM">Filip Zinowiew - CEO</span>
            <span className="footer-text5 TextSM">
              filip.zinowiew@fzsolutions.pl
            </span>
          </div>
        </div>
      </div>
      ...
      <span className="footer-text6">
        <span className="TextSM">Copyright © 2024 fzsolutions.pl</span>
        <br></br>
      </span>
    </div>
  )
